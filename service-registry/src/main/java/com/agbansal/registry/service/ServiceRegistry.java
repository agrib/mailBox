package com.agbansal.registry.service;

import com.agbansal.registry.database.DBClient;
import com.agbansal.registry.models.Registration;
import com.agbansal.registry.models.ServiceNode;
...
public class ServiceRegistry {
    ...
    @Autowired
    public ServiceRegistry(final DBClient dbClient){this.dbClient = dbClient; }

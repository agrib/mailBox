package com.agbansal.registry.database;
        ...
        try {
            ...
            return CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    while (rs.next()) {
                        serviceNodes.add(new ServiceNode(rs.getString(0), rs.getString(1), rs.getString(2), rs.getInt(3)));
                    }
                    return serviceNodes;
                } catch (SQLException throwable) {
                    logger.error("Exception while getting results");
